...
abstract contract TestErrors {
    ...
    function err(bytes4 selector, uint arg1) internal pure returns (bytes memory) {
        return abi.encodeWithSelector(selector, arg1);
    }
    ...
    function err(bytes4 selector, address arg1, uint arg2) internal pure returns (bytes memory) {
        return abi.encodeWithSelector(selector, arg1, arg2);
    }

    function err(bytes4 selector, uint arg1, address arg2) internal pure returns (bytes memory) {
        return abi.encodeWithSelector(selector, arg1, arg2);
    }
    ...
    function err(bytes4 selector, uint arg1, uint arg2) internal pure returns (bytes memory) {
        return abi.encodeWithSelector(selector, arg1, arg2);
    }

    function err(bytes4 selector, bytes32 arg1, uint arg2) internal pure returns (bytes memory) {
        return abi.encodeWithSelector(selector, arg1, arg2);
    }

    function err(bytes4 selector, uint arg1, uint arg2, address arg3) internal pure returns (bytes memory) {
        return abi.encodeWithSelector(selector, arg1, arg2, arg3);
    }

    function err(bytes4 selector, bytes32 arg1, uint arg2, address arg3) internal pure returns (bytes memory) {
        return abi.encodeWithSelector(selector, arg1, arg2, arg3);
    }
}
